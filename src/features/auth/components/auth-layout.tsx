  ...
  return (
    <div className='relative hidden flex-1 overflow-hidden lg:flex'>
      ...
      <div className='absolute inset-0'>
        ...
        <div className='animate-blob animation-delay-2000 absolute top-0 -right-4 h-72 w-72 rounded-full bg-cyan-500/30 opacity-70 mix-blend-screen blur-xl filter' />
        <div className='animate-blob animation-delay-4000 absolute -bottom-8 left-20 h-72 w-72 rounded-full bg-indigo-500/30 opacity-70 mix-blend-screen blur-xl filter' />
      </div>
...
export function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div
      className={`flex min-h-screen w-full flex-col lg:flex-row ${inter.variable} font-sans`}
    >
